...
import { StyleSheet, View, ScrollView, Button, TextInput, Text, Image, TouchableOpacity, Icon } from 'react-native';
    ...
    <>
      {station != undefined ?
        <ScrollView>
          ...
          <View style= {{padding: 10, width: '100%', backgroundColor: 	'#212E53', height:170}}>
            <TouchableOpacity>
